...
const state = Vue.observable({
    ...
    generatedDataTableHeader: [
        {text:"TEST", value: "order_date"},
        {text:"TEST", value: "customer_code"},
        {text:"TEST", value: "route_code"},
        {text:"TEST", value: "item_category_code"},
        {text:"TEST", value: "ship_to"},
        {text:"TEST", value: "order_no"},
        {text:"TEST", value: "remarks"},
        {text:"TEST", value: "item_code"},
        {text:"TEST", value: "quantity"},
    ],
