  ...
  computed: {
    tabs: function tabs() {
      ...
      // },
      {
        ...
        icon: 'mdi-file-check',
        component: function component() {
          return Promise.all(/*! import() */[__webpack_require__.e(29), __webpack_require__.e(27)]).then(__webpack_require__.bind(null, /*! ./common/Transactions.vue */ "./resources/js/pages/Principals/common/Transactions.vue"));
        }
      }, {
        title: 'Masterfiles',
