...
class OthersNIController extends Controller
{
    private $PRINCIPAL_CODE = 'others_ni';
    ...
    //                             // ---------------------------------------------------------------------------
    //                             if (
    //                                 !isset($res['output_template_variations'][$tvc_index]['output_template'][$doc_no])
    //                             ) {
    //                                 $res['output_template_variations'][$tvc_index]['output_template'][$doc_no] = [];
    //                             }
    //                             array_push(
    //                                 $res['output_template_variations'][$tvc_index]['output_template'][$doc_no],
    //                                 $arrGenerated
    ...
    public function generateTemplatedData(Request $request)
    {
        ...
        try {
            ...
            $pendingInvoices = DB::table(PrincipalsUtil::$TBL_INVOICES)
                ...
                //         ->first()->vendor_code
                // )
                ->whereNotIn('vendor_code', function($q){
                    $q->select('vendor_code')->from(PrincipalsUtil::$TBL_PRINCIPALS);
                })
