        ...
        try {
            ...
            foreach ($pendingInvoices as $pendingInvoice) {
                ...
                if ($chunk_line_count > 0) {
                    ...
                    if (
                        !isset($res['output_template_variations'][0]['output_template'][$order_date])
                    ) {
                        $res['output_template_variations'][0]['output_template'][$order_date] = [];
                    }
                    array_push(
                        $res['output_template_variations'][0]['output_template'][$order_date],
                        $arrGenerated
            ...
            foreach ($pendingInvoices as $pendingInvoice) {
                ...
                if ($chunk_line_count > 0) {
                    ...
                    // group output_template_variations
                    if (
                        !isset($res['output_template_variations'][1]['output_template'][$order_date])
                    ) {
                        $res['output_template_variations'][1]['output_template'][$order_date] = [];
                    }
                    array_push(
                        $res['output_template_variations'][1]['output_template'][$order_date],
                        $arrGenerated
