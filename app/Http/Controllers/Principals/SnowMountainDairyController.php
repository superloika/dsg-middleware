...
class SnowMountainDairyController extends Controller
{
    public static $PRINCIPAL_CODE = 'snow_mountain_dairy';
                ...
                foreach ($pendingInvoices as $pendingInvoice) {
                    ...
                    if ($tvc_index == 0) {
                        ...
                        $arrGenerated = [
                            ...
                            'bulk_qty' => intval($bulk_qty),
                            'loose_qty' => intval($loose_qty),
