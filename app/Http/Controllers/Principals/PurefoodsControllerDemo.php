...
class PurefoodsControllerDemo extends Controller
{
    private $PRINCIPAL_CODE = '';
    private $return_indicators = [];
    private $return_reasons = [];
        ...
        try {
            ...
            */
            $this->return_indicators = [
                ...
                1 => 'Trade Return Good',
                2 => 'Trade Return Bad',
                3 => 'Outright / Devuelto Good',
                4 => 'Outright / Devuelto Bad',
            ];
            $this->return_reasons = [
                0 => '',
            ...
            if($exportSI) {
                ...
                if(
                    ...
                    foreach ($pendingInvoices as $pendingInvoice) {
                        ...
                        if(in_array($progressPercent, [1,10,30,50,70,90,95,96,97,98,99,100])) {
                        ...
                        // $customer_code =        '5703681'; // for BR test (Alta Citta-ASC - BR ID)
                    ...
                    $request->status ==PrincipalsUtil::$STATUS_COMPLETED
                    || $request->status ==PrincipalsUtil::$STATUS_UPLOADED
                ){
                    foreach ($pendingInvoices as $pendingInvoice) {
            ...
            if($exportCM) {
                ...
                if(
                    ...
                    foreach ($returns as $return) {
                        ...
                        $return_indicator =     $this->return_indicators[$return->return_indicator] ?? '';
                        $vendor_code =          $return->vendor_code;
                        $sm_code =              $return->sm_code;
                        $sm_name =              $return->sm_name;
                        $remarks =              $this->return_reasons[$return->remarks] ?? '';
                    ...
                    if ($lineCount > 2) {
                        ...
                        if (count($arrFileContentLine) > 1) {
                            ...
                            if(
                                ...
                                && ($customer_code_supplier != '' || $customer_code_supplier != '#N/A')
                            ) {
                                $arrLines[] = [
                                    'main_vendor_code' => $this->PRINCIPAL_CODE,
        ...
        $arr = [
            ...
            "generatedDataTableHeader" => [
                [
                    ...
                    ["text" => "Price (NAV, VATinc)",        "value" => "price"],
                    ["text" => "Amount (NAV, Discounted)",   "value" => "amount"],
                    ["text" => "Price (VATex)",              "value" => "price_supplier"],
                    ["text" => "Amount (Discounted,VATex)",  "value" => "amount_supplier"],
                    ["text" => "SM Code (NAV)",              "value" => "sm_code"],
                    ["text" => "SM Name (NAV)",              "value" => "sm_name"],
                    ["text" => "DSP",                        "value" => "dsp"],
            ...
            // "return_indicators" => $this->return_indicators,
